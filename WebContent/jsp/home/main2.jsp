...
<%@ include file="/jsp/part/head.jspf" %>
	...
	<!-- 메인컨텐츠 -->
	<div class="con grid image-grid ">
		<div class="grid-block">
			<div class="tile ">
				<a class="tile-link" href="#"> <img class="tile-img tile-img1"
		...
		<div class="grid-block">
			<div class="tile">
				<a class="tile-link" href="#"> <img class="tile-img tile-img2"
		...
		<div class="grid-block">
			<div class="tile">
				<a class="tile-link" href="#"> <img class="tile-img tile-img3"
		...
		<div class="grid-block">
			<div class="tile">
				<a class="tile-link" href="#"> <img class="tile-img tile-img6"
		...
		<div class="grid-block">
			<div class="tile">
				<a class="tile-link" href="#"> <img class="tile-img tile-img7"
		...
		<div class="grid-block">
			<div class="tile">
				<a class="tile-link" href="#"> <img class="tile-img tile-img8"
